  ...
  const sideClass =
    side === "right"
      ...
      : side === "left"
        ...
        : side === "top"
          ? "inset-x-0 top-0 border-b data-ending-style:translate-y-[-2.5rem] data-starting-style:translate-y-[-2.5rem]"
    ...
    <Sheet open={open} onOpenChange={setOpen} {...props}>
      <SheetPortal>
        ...
        <Dialog.Popup
          ...
          data-side={side}
          className={cn(
            "fixed z-50 flex flex-col bg-background text-sidebar-foreground shadow-lg transition duration-200 ease-in-out",
