...
const categoriesData = JSON.parse(readFileSync(join(ROOT, "src/data/categories.json"), "utf-8"))
...
const productsData = JSON.parse(readFileSync(join(ROOT, "src/data/products-index.json"), "utf-8"))
